  ...
  const socaialIcons = [
    {
      icon: instagram,
      alt: "Instagram",
      link: "https://www.instagram.com/jofijohnson?igsh=MWFubXh0Njl6ZnZmMQ==",
    },
    { icon: github, alt: "github", link: "https://github.com/jofimoljohnson" },
    {
      icon: linkedin,
      alt: "linkedin",
      link: "https://www.linkedin.com/in/jofijo96/",
    },
  ];
        ...
        >
          ...
          >
              ...
              {socaialIcons.map((social, index) => (
                ...
                >
                  <img
                    src={social.icon}
                    alt={social.alt}
                    className={`w-8 h-8 sm:w-8 sm:h-10
                       object-contain ${
            ...
            >
              ...
              user-friendly, and scalable web applications using React.js,
              Node.js, Express.js, and MongoDB. I focus on clean code,
